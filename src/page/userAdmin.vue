              ...
              <div class="userItem">
                ...
                <div class="date">
                  <el-form-item label="注册渠道">
                    ...
                    <el-option v-for="item in channelList"  :label="item.gameName" :value="item.gameKey"></el-option>
    ...
    >
      ...
      <el-form :model="addform" :rules="rules" ref="addform" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="注册渠道" prop="registerChannelGameKey">
            ...
            <el-select @change="getLabel" v-model="addform.registerChannelGameKey" placeholder="请选择注册渠道">
              <el-option v-for="item in channelList"  :label="item.gameName" :value="item.gameKey"></el-option>
...
<script>
  ...
  import {UserAllData,userList,getChannel,submitEdit,addUser} from '@/api/getData'
    ...
    data() {
      return {
        ...
        rules: {
          ...
          registerChannelGameKey: [
            {  required: true, message: '请至少选择一个注册渠道', trigger: 'change' }
          ]
        },
        addform:{
    ...
    methods: {
      getLabel(value) {
        ...
        obj = this.channelList.find((item)=>{
          return item.gameKey === value;
        });

        this.addform.registerChannelGameName = obj.gameName
      },
      submitEdit(){
